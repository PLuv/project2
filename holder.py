def gate():
    ...
    "6": '<!-- Header -->',\
    "7": '<div class="header">',\
    "8": '<a id="logo"><img src="/static/pics/favicon-32.png" alt="~Speak~"> #"Channel Name"<span class="header-center"><img src="/static/pics/dot40x40.png">  </span><span id="logged_in_user"></span></a>',\
